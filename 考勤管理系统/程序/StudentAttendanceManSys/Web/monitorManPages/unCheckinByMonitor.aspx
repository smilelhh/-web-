<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="unCheckinByMonitor.aspx.cs"
    Inherits="Web.monitorManPages.unCheckinByMonitor" %>
...
<body>
    ...
    <div align="center">
        ...
        <webdiyer:AspNetPager ID="AspNetPager1" runat="server" CssClass="anpager" FirstPageText="首页"
            ...
            Style="margin-top: 20px;" OnPageChanging="AspNetPager1_PageChanging" 
