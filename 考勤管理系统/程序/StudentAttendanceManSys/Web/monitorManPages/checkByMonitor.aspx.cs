...
{
    public partial class checkBymonitor : System.Web.UI.Page
    {
        ...
        protected void btnSure_Click(object sender, EventArgs e)
        {
            ...
            Response.Write("<script>location.href='confirmCheckByMonitor.aspx';</script>");
        }

        protected void btnAlter_Click(object sender, EventArgs e)
        {
            List<Attendance> attenList = Session["attenList"] as List<Attendance>;
            Response.Write("<script>location.href='unCheckinByMonitor.aspx?courTableID=" + attenList[0].CourTableID + "';</script>");
        }
