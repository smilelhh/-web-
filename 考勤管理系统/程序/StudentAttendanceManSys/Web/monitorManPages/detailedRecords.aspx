<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="detailedRecords.aspx.cs"
    Inherits="Web.monitorManPages.detailedRecords" %>
        ...
        <div style="margin-top: 50px;">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="课程" ItemStyle-Width="180" DataField="course">
                        <ItemStyle></ItemStyle>
                    </asp:BoundField>
