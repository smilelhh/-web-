<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="showTeachers.aspx.cs" Inherits="Web.managerManPages.manageTeachers.showTeachers" %>
...
<body>
    ...
    <div align="center" style="margin-top: 10px;">
        <div align="center">
            《教师管理》<asp:ImageButton ID="ImageButton_add" runat="server" ImageUrl="~/images/add.gif"
        ...
        <div style="margin-top: 20px;">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="教师号" HeaderStyle-Width="90" DataField="teacherId">
                        <ItemStyle></ItemStyle>
                    ...
                    <asp:BoundField HeaderText="职称" HeaderStyle-Width="90" DataField="title">
                        <HeaderStyle Width="120px"></HeaderStyle>
                    </asp:BoundField>
                    <asp:BoundField HeaderText="联系电话" HeaderStyle-Width="90" DataField="phone">
