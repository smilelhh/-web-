<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addTeacher.aspx.cs" Inherits="Web.managerManPages.manageTeachers.addTeacher" %>
    ...
    <div class="container" align="center">
        <table cellspacing="0" style="width: 40%;">
            ...
            <tr class="infoRow" style="height: 35px;">
                ...
                <td align="left">
                    &nbsp;&nbsp;<asp:TextBox ID="TextBox_teachId" runat="server" CssClass="textBox"></asp:TextBox>
                    <asp:CustomValidator ID="checkTeachId" runat="server" ErrorMessage="CustomValidator"
