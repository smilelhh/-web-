<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addCourse.aspx.cs" Inherits="Web.managerManPages.manageCourses.addCourse" %>
        ...
        <table cellspacing="0" >
            ...
            <tr class="footRow">
                <td align="center" colspan="2">
                    ...
                    <asp:ImageButton ID="ImageButton_back" runat="server" 
                        ImageUrl="~/images/back.jpg" onclick="ImageButton_back_Click" />
                </td>
            </tr>
        </table>
    </div>
