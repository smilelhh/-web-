<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editStudent.aspx.cs" Inherits="Web.managerManPages.manageStudents.editStudent" %>
    ...
    <div class="container" align="center">
        <table cellspacing="0" style="width: 40%;">
            ...
            <tr class="infoRow" style="height: 35px;">
                ...
                <td align="left">
                    &nbsp;&nbsp;<asp:Label ID="Label_stuId" runat="server" Text="Label"></asp:Label>
                </td>
            </tr>
            <tr class="infoRow" style="height: 35px;">
                <td align="right">
