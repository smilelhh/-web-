<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="showStudents.aspx.cs" Inherits="Web.managerManPages.manageStudents.showStudents" %>
...
<body>
    ...
    <div align="center" style="margin-top: 10px;">
        <div style="margin-top: 20px;">
            <div align="center">
                选择班级：<asp:DropDownList 
                    ID="DropDownList_class" runat="server" AutoPostBack="True" 
                    onselectedindexchanged="DropDownList_class_SelectedIndexChanged">
                </asp:DropDownList>
                <br /><br />
                《<asp:Label ID="Label_className" runat="server" Text="Label"></asp:Label>》班级学生管理<asp:ImageButton
                    ID="ImageButton_add" runat="server" ImageUrl="~/images/add.gif" OnClick="ImageButton_add_Click"
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="学号" HeaderStyle-Width="90" DataField="stuId">
                        <ItemStyle></ItemStyle>
                    </asp:BoundField>
