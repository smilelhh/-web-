<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editClass.aspx.cs" Inherits="Web.managerManPages.manageCourses.editClass" %>
    ...
    <div class="container" align="center">
        <table cellspacing="0">
            ...
            <tr class="infoRow">
                ...
                <td align="left">
                    &nbsp;&nbsp;<asp:DropDownList ID="DropDownList_monitor" runat="server" class="dropDownList">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr class="footRow">
