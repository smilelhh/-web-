<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="showClasses.aspx.cs" Inherits="Web.managerManPages.manageClasses.showClasses" %>
...
<body>
    ...
    <div align="center" style="margin-top: 10px;">
        <div>
            《班级信息管理》<asp:ImageButton ID="ImageButton_add" runat="server" ImageUrl="~/images/add.gif"
        ...
        <div style="margin-top: 50px;">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="专业/系" ItemStyle-Width="100" DataField="depart">
                        <ItemStyle></ItemStyle>
                    </asp:BoundField>
                    <asp:BoundField HeaderText="年级" ItemStyle-Width="70" DataField="grade">
                        <ItemStyle></ItemStyle>
                    </asp:BoundField>
                    <asp:BoundField HeaderText="班级名" ItemStyle-Width="120" DataField="name">
                        <ItemStyle></ItemStyle>
                    </asp:BoundField>
                    <asp:BoundField HeaderText="人数" ItemStyle-Width="70" DataField="studCount">
                        <ItemStyle></ItemStyle>
                    </asp:BoundField>
                    <asp:BoundField HeaderText="班长" ItemStyle-Width="90" DataField="monitorName">
                        <ItemStyle></ItemStyle>
                    </asp:BoundField>
                    <asp:BoundField HeaderText="班主任" ItemStyle-Width="90" DataField="teacherName">
                        <ItemStyle></ItemStyle>
                    </asp:BoundField>
