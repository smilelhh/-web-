<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addCourseTable.aspx.cs"
    Inherits="Web.managerManPages.manageCourses.addCourseTable" %>
    ...
    <div class="container" align="center">
        <table style="margin-top: 30px; width: 40%;" cellspacing="0">
            ...
            <tr class="infoRow" style="height: 35px;">
                ...
                <td align="left" >
                    &nbsp;&nbsp;
                    <asp:DropDownList ID="DropDownList_course" runat="server" class="textBox">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr class="infoRow" style="height: 35px;">
                ...
                <td align="left">
                    &nbsp;&nbsp;
                    <asp:DropDownList ID="DropDownList_teacher" runat="server" class="textBox">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr class="infoRow" style="height: 35px;">
                ...
                <td align="left">
                    &nbsp;&nbsp;
                    <asp:DropDownList ID="DropDownList_class" runat="server" class="textBox">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr class="infoRow" style="height: 35px;">
