<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="showCourseTable.aspx.cs"
    Inherits="Web.managerManPages.manageCourses.showCourseTable" %>
...
<body>
    ...
    <div align="center" style="margin-top: 10px;">
        <div>
            《课程教学安排》<asp:ImageButton ID="ImageButton_add" runat="server" ImageUrl="~/images/add.gif"
        ...
        <div style="margin-top: 20px;">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="课程名称" HeaderStyle-Width="170" DataField="courseName">
                        <ItemStyle></ItemStyle>
                    </asp:BoundField>
                    <asp:BoundField HeaderText="任课老师" HeaderStyle-Width="90" DataField="teacherName">
                        <ItemStyle></ItemStyle>
                    </asp:BoundField>
                    <asp:BoundField HeaderText="班级名称" HeaderStyle-Width="120" DataField="className">
                        <ItemStyle></ItemStyle>
                    </asp:BoundField>
                    <asp:BoundField HeaderText="学期" HeaderStyle-Width="170" DataField="semester">
                        <ItemStyle></ItemStyle>
                    </asp:BoundField>
                    <asp:HyperLinkField HeaderText="查看详情" Text="查看" DataNavigateUrlFields="ID"
                        DataNavigateUrlFormatString="showDetailCourseTable.aspx?ID={0}" />
