<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="showDetailCourseTable.aspx.cs"
    Inherits="Web.managerManPages.manageCourses.showDetailCourseTable" %>
        ...
        <div style="margin-top: 20px;">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="周次" HeaderStyle-Width="90" DataField="week" DataFormatString="{0}周">
                        <ItemStyle></ItemStyle>
                        <HeaderStyle Width="90px"></HeaderStyle>
                    </asp:BoundField>
                    ...
                    <asp:TemplateField HeaderText="编辑/删除">
                        <ItemTemplate>
                            <asp:ImageButton ID="ImageButton_edit" runat="server" CausesValidation="False" Text="Button"
                                ImageUrl="~/images/edit.gif" OnClick="ImageButton_edit_Click" CommandArgument='<%# Eval("ID")+","+Eval("week") %>'>
                            </asp:ImageButton>
                            /
