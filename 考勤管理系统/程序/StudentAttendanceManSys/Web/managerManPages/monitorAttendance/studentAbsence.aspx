<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="studentAbsence.aspx.cs"
    Inherits="Web.managerManPages.monitorAttendance.studentAbsence" %>
        ...
        <div style="margin-top: 50px;">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="班级" HeaderStyle-Width="150" DataField="className">
                        <ItemStyle></ItemStyle>
                    </asp:BoundField>
                    <asp:BoundField HeaderText="出勤状态" HeaderStyle-Width="90" DataField="status">
                        <ItemStyle></ItemStyle>
                    </asp:BoundField>
                    <asp:BoundField HeaderText="课程" HeaderStyle-Width="90" DataField="course">
                        <ItemStyle></ItemStyle>
                    </asp:BoundField>
                    ...
                    <asp:BoundField HeaderText="备注" HeaderStyle-Width="90" DataField="remark" />
                </Columns>
