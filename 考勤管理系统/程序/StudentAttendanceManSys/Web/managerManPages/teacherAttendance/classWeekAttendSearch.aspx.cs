...
{
    public partial class classWeekAttendSearch : System.Web.UI.Page
    {
        ...
        private void bind()
        {
            ...
            DataTable dt = PageUtil.getProcessedDataTable(commBLL.getWeekStudentAttendStatistics(true), filter);
