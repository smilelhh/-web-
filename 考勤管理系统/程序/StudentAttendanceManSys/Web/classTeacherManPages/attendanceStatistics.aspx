<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="attendanceStatistics.aspx.cs" Inherits="Web.classTeacherManPages.attendanceStatistics" %>
        ...
        <div style="margin-top: 50px;">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                ...
                <Columns>
                    ...
                    <asp:HyperLinkField HeaderText="查看详情" Text="查看" ItemStyle-Width="100"
                        DataNavigateUrlFormatString="classStudentAttendDetail.aspx?classID={0}" 
