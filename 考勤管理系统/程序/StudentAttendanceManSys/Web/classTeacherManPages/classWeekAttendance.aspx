<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="classWeekAttendance.aspx.cs"
    Inherits="Web.classTeacherManPages.weekAttendance" %>
...
<body>
    ...
    <div align="center" style="margin-top: 50px;">
        <div>
            <b style="color: Red;">《<asp:Label ID="Label_className" runat="server" Text="Label"></asp:Label>》&nbsp;班级周到课率查询
            </b>
        </div>
        <div style="margin-top: 50px;">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                ...
                <Columns>
                    ...
                    <asp:HyperLinkField HeaderText="到课率详细" Text="查看" DataNavigateUrlFields="classID,week"
